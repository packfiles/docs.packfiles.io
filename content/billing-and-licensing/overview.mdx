...
Your Project's Meter is credited with a [free trial allotment](free-trial) of Capacity when it's first created. Additional Capacity is credited any time you purchase one or more [**Boxes**](overview#about-boxes). 
