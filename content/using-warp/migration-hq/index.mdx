...
layout:
  title:
    visible: true
---
<Frame caption="The *Migration HQ* page.">
  <img src="/content/media/images/image (39).png" alt="A Warp Project&#x27;s &#x22;Migration HQ&#x22; page on GitHub." />
</Frame>

**The _Migration HQ_ repository** — _HQ_ is short for “headquarters” — is Warp’s primary user interface. When you create a Project, Warp generates a _Migration HQ_ repository for that project; it’s the “control panel” that you use to manage the migration process.

**You will use the [_Issues_](issues/) page of _Migration HQ_ most often.** Warp uses this page for the list of migrations. For each repository that Warp finds in the sources you provide (e.g. Azure DevOps), it creates an issue representing that repository. Each issue acts as the user interface for managing the migration of its repository. You enter Warp commands in the issue’s _Comments_ section, including the command to migrate the issue from the source to GitHub.

You might also use these _Migration HQ_ pages on occasion:
