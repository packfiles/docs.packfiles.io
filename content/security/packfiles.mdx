...
Key security features in Warp, such as [customer-owned credential management](warp-security-model/credential-management), [private compute](warp-security-model/), and [data privacy](warp-security-model/data-privacy) can't be disabled or configured improperly by mistake. Because these features are inherently part of Warp's design, customers don't need to perform extensive or complicated configurations to enjoy the benefits of these protections. They're always present and active for Projects of any size.
