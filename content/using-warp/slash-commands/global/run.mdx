...
Executes a [custom script](../../migration-hq/custom-scripts) defined in your project's `warp.yml` configuration file. Scripts run on a GitHub Actions runner agent and results are posted as a comment on the issue.
...
See [Custom Scripts](../../migration-hq/custom-scripts) for configuration details.
