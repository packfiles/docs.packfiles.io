...
layout:
  title:
    visible: true
---
Access policies let you control who can run Warp commands in your _Migration HQ_ repository. You configure them in the `policies` section of your [`warp.yml`](warp-yml) file.
