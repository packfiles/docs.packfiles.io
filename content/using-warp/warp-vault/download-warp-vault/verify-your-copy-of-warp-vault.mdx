---
title: "Verify Your Copy of Warp Vault"
icon: signature-lock
...
* [macOS](verify-your-copy-of-warp-vault#macos)
* [Windows](verify-your-copy-of-warp-vault#windows)
* [Linux](verify-your-copy-of-warp-vault#linux)
...
<Frame>
  <img src="/content/media/images/image (117).png" alt="" width="375" />
</Frame>

In the Properties view, select **Digital Signatures**, then click on **Details**.

<Frame>
  <img src="/content/media/images/image (119).png" alt="" width="375" />
</Frame>
...
<Frame>
  <img src="/content/media/images/image (120).png" alt="" width="375" />
</Frame>
